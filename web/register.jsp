<%-- 
    Document   : register
    Created on : 15 Jul, 2025, 8:13:46 PM
    Author     : CAREN
--%>
...
.booking-form a:hover {
    color: #ffaa00;   /* lighter gold on hover */
            ...
            <div class="booking-form-container">
                <form class="booking-form" method="post" action="">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <a for="terms" href="terms_and_conditions.jsp" >I agree to the Terms and Conditions and Privacy Policy</a>
                    </div>
