...
<%
    ...
    try {
        ...
        String routeFrom = request.getParameter("route_from");
        String routeTo = request.getParameter("route_to");
        ...
        if (busName != null && routeFrom != null && routeTo != null && depTime != null && arrTime != null) {
            ...
            String sql = "INSERT INTO bus_details (bus_name, route_from, route_to, departure_time, arrival_time, total_seats, available_seats, price) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement ps = conn.prepareStatement(sql);

            ps.setString(1, busName);
            ps.setString(2, routeFrom);
            ps.setString(3, routeTo);
            ps.setTime(4, java.sql.Time.valueOf(depTime + ":00"));
            ps.setTime(5, java.sql.Time.valueOf(arrTime + ":00"));
...
<head>
    <meta charset="UTF-8">
    <title>Add Bus - Ridesync Admin</title>
...
<div class="admin-container">
    <div class="header">
        <h2><i class="fa-solid fa-bus"></i> Add New Bus</h2>
    </div>

    <div class="form-card">
        <form method="post" action="add_bus.jsp">
...
<% if (showSuccessPopup) { %>
    <script>
        Swal.fire({
            ...
            window.location.href = 'admin_buses.jsp';
        });
    </script>
<% } %>
