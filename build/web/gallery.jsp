    ...
    <main class="page">
        <div class="container">
            <div class="section-title">
                <h2>Our Bus Fleet Gallery</h2>
                <p>Explore our modern and comfortable buses</p>
            </div>
            
            <div class="gallery">
                <div class="gallery-item">
                    <img src="images/bus8.png" alt="Luxury Bus">
                ...
                <div class="gallery-item">
                    <img src="images/bus6.png" alt="Bus on Road">
                    <div class="overlay">On the Highway</div>
                </div>
                <div class="gallery-item">
                    <img src="images/bus5.png" alt="Night Bus">
                    <div class="overlay">Bus Stand</div>
                </div>
                <div class="gallery-item">
                    <img src="images/bus4.png" alt="Bus Seats">
                    <div class="overlay">Comfortable Seating</div>
                </div>
                <div class="gallery-item">
                    <img src="images/bus3.png" alt="Bus Station">
                    <div class="overlay">Safer</div>
                </div>
            </div>
        </div>
    </main>
